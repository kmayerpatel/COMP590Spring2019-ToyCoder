...
public class ModelFreeArithmeticEncoder {
	...
	public ModelFreeArithmeticEncoder(int rangeBitWidth) {
	...
	public void encode(double cdfLow, double cdfHigh, BitSink bit_sink) throws IOException {
		long range_width = _high - _low + 1;
		
		long new_low = _low + ((long) (range_width * cdfLow));
		long new_high = _low + ((long) (range_width * cdfHigh)) - 1L;
